...
#' @param x vector of variables of the likelihood function
#' @param param vector of paremeters of the likelihood function
#' @param ... additional arguments
#'
#' @return a list of the index of the maximum likelihood estimate, parameter value of the max likelihood estimate,
